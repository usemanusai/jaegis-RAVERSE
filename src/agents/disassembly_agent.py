...
class DisassemblyAgent:
    ...
    def cache_disassembly(
        ...
        # Use execute_values_query for batch inserting instructions to prevent N+1 queries.
        # This reduces thousands of separate queries into a single database round-trip.
        query = """
