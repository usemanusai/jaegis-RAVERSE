#!/usr/bin/env python
"""
Validation script for AI Agent Pipeline System
Tests all core components and verifies functionality
"""
...
from src.agents import (
    ...
    PipelineMemory, ContextManager, ErrorHandler, ErrorSeverity,
    CircuitBreaker, MCPPipelineIntegration
)
...
def main():
    """Run all tests"""
    print("\n" + "="*50)
    print("AI Agent Pipeline System - Validation")
    print("="*50 + "\n")
